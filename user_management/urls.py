...
from user_management.views import signup_views, authentication_views, user_profile_views, change_password_views
...
urlpatterns = [
    ...
    path('user/change-password', change_password_views.change_password, name='change-password')
]
